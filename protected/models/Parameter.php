 ...
 * @property ParameterOption[] $parameterOptions
 */
class Parameter extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'parameterInActivities' => array(self::HAS_MANY, 'ParameterInActivity', 'parameter'),
			'parameterOptions' => array(self::HAS_MANY, 'ParameterOption', 'parameter'),
		);
	}
